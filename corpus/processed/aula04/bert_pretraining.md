<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 1, "page_start": 1, "page_end": 1, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=1", "section": "1 Introduction", "subsection": null, "heading_path": ["1 Introduction"]} -->

## BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding
<!-- section_metadata: {"section": "BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding", "subsection": null, "heading_path": ["BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 2, "page_start": 2, "page_end": 2, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=2", "section": "2.2 Unsupervised Fine-tuning Approaches", "subsection": null, "heading_path": ["2.2 Unsupervised Fine-tuning Approaches"]} -->
...
<!-- section_metadata: {"section": "2.1 Unsupervised Feature-based Approaches", "subsection": null, "heading_path": ["2.1 Unsupervised Feature-based Approaches"]} -->
...
<!-- section_metadata: {"section": "2.2 Unsupervised Fine-tuning Approaches", "subsection": null, "heading_path": ["2.2 Unsupervised Fine-tuning Approaches"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 3, "page_start": 3, "page_end": 3, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=3", "section": "3 BERT", "subsection": null, "heading_path": ["3 BERT"]} -->

Figure 1: Overall pre-training and fine-tuning procedures for BERT. Apart from output layers, the same architectures are used in both pre-training and fine-tuning. The same pre-trained model parameters are used to initialize models for different down-stream tasks. During fine-tuning, all parameters are fine-tuned. [CLS] is a special symbol added in front of every input example, and [SEP] is a special separator token (e.g. separating questions/answers).

<!-- image_metadata: {"image_id": "bert_pretraining_page003_image001", "document_name": "bert_pretraining.pdf", "page": 3, "section": "3 BERT", "subsection": null, "heading_path": ["3 BERT"], "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=3", "bbox": {"l": 74.74064731150865, "t": 779.5005631873306, "r": 522.7491486504673, "b": 600.8552500084884}, "image_description": "Esta figura ilustra os diferentes estágios de pre-treinamento e fine-tuning de modelos BERT para abordagens não supervisionadas (NSP Mask LM) e supervisionadas (MNLI, SQuAD), destacando a arquitetura e as etapas de adaptação dos modelos para áreas específicas de Compreensão de Linguagem Natural (CLN). Ela apresenta uma visão comparativa de dois modelos BERT, mostrando como são aprofundados com camadas adicionais para ajuste fino em tarefas CLN específicas. Essa ilustração provavelmente faz parte de um documento acadêmico ou um artigo científico que discute a eficácia desses modelos em processamento de linguagem.\n", "image_description_model": "nvidia/nemotron-nano-12b-v2-vl:free", "image_description_skipped": false, "image_description_primary_model": "nvidia/nemotron-nano-12b-v2-vl:free"} -->

## 2.3 Transfer Learning from Supervised Data
<!-- section_metadata: {"section": "2.3 Transfer Learning from Supervised Data", "subsection": null, "heading_path": ["2.3 Transfer Learning from Supervised Data"]} -->
...
## 3 BERT
<!-- section_metadata: {"section": "3 BERT", "subsection": null, "heading_path": ["3 BERT"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 4, "page_start": 4, "page_end": 4, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=4", "section": "3.1 Pre-training BERT", "subsection": null, "heading_path": ["3.1 Pre-training BERT"]} -->
...
We use WordPiece embeddings (Wu et al. , 2016) with a 30,000 token vocabulary. The first token of every sequence is always a special classification token ([CLS]). The final hidden state corresponding to this token is used as the aggregate sequence representation for classification tasks. Sentence pairs are packed together into a single sequence. We differentiate the sentences in two ways. First, we separate them with a special token ([SEP]). Second, we add a learned embedding to every token indicating whether it belongs to sentence A or sentence B. As shown in Figure 1 , we denote input embedding as E, the final hidden vector of the special [CLS] token as C ∈ R H , and the final hidden vector for the i th input token as Ti Ti ∈ R H .
...
<!-- section_metadata: {"section": "3.1 Pre-training BERT", "subsection": null, "heading_path": ["3.1 Pre-training BERT"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 5, "page_start": 5, "page_end": 5, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=5", "section": "4.1 GLUE", "subsection": null, "heading_path": ["4.1 GLUE"]} -->

Figure 2: BERT input representation. The input embeddings are the sum of the token embeddings, the segmentation embeddings and the position embeddings.

<!-- image_metadata: {"image_id": "bert_pretraining_page005_image002", "document_name": "bert_pretraining.pdf", "page": 5, "section": "4.1 GLUE", "subsection": null, "heading_path": ["4.1 GLUE"], "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=5", "bbox": {"l": 115.45808866135775, "t": 779.9332993178249, "r": 471.8974461510777, "b": 674.7968536313456}, "image_description": " Esta figura representa um modelo de tokenização de frase com a inserção de embedding de segmento e posição. Cada token da entrada, como \"cute\", \"he\" ou \"#ing\" é associado a um embedding de token, que é amplificado por embeddings específicos de segmento e posição. Esta técnica é comum em modelos de linguagem e tradução automática, indicando possivelmente uma discussão sobre arquiteturas de redes neurais em processamento de linguagem natural.\n", "image_description_model": "nvidia/nemotron-nano-12b-v2-vl:free", "image_description_skipped": false, "image_description_primary_model": "nvidia/nemotron-nano-12b-v2-vl:free"} -->
...
<!-- section_metadata: {"section": "3.2 Fine-tuning BERT", "subsection": null, "heading_path": ["3.2 Fine-tuning BERT"]} -->
...
## 4 Experiments
<!-- section_metadata: {"section": "4 Experiments", "subsection": null, "heading_path": ["4 Experiments"]} -->

In this section, we present BERT fine-tuning results on 11 NLP tasks.

## 4.1 GLUE
<!-- section_metadata: {"section": "4.1 GLUE", "subsection": null, "heading_path": ["4.1 GLUE"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 6, "page_start": 6, "page_end": 6, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=6", "section": "4.2 SQuAD v1.1", "subsection": null, "heading_path": ["4.2 SQuAD v1.1"]} -->
...
|                                                                    | System MNLI-(m/mm) QQP QNLI SST-2 CoLA STS-B MRPC RTE  392k 363k 108k 67k 8.5k 5.7k 3.5k 2.5k -   | Average   |
|--------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|-----------|
...
## 4.2 SQuAD v1.1
<!-- section_metadata: {"section": "4.2 SQuAD v1.1", "subsection": null, "heading_path": ["4.2 SQuAD v1.1"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 7, "page_start": 7, "page_end": 7, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=7", "section": "5 Ablation Studies", "subsection": null, "heading_path": ["5 Ablation Studies"]} -->
...
## 4.3 SQuAD v2.0
<!-- section_metadata: {"section": "4.3 SQuAD v2.0", "subsection": null, "heading_path": ["4.3 SQuAD v2.0"]} -->

The SQuAD 2.0 task extends the SQuAD 1.1 problem definition by allowing for the possibility that no short answer exists in the provided paragraph, making the problem more realistic.

We use a simple approach to extend the SQuAD v1.1 BERT model for this task. We treat questions that do not have an answer as having an answer span with start and end at the [CLS] token. The probability space for the start and end answer span positions is extended to include the position of the [CLS] token. For prediction, we compare the score of the no-answer span: snull = S · C + E · C to the score of the best non-null span s ˆ i,j = max j≥i S · Ti Ti + E·Tj . We predict a non-null answer when s ˆ ˆi,j &gt; snull + τ , where the threshold τ is selected on the dev set to maximize F1. We did not use TriviaQA data for this model. We fine-tuned for 2 epochs with a learning rate of 5e-5 and a batch size of 48.
...
## 4.4 SWAG
<!-- section_metadata: {"section": "4.4 SWAG", "subsection": null, "heading_path": ["4.4 SWAG"]} -->
...
## 5 Ablation Studies
<!-- section_metadata: {"section": "5 Ablation Studies", "subsection": null, "heading_path": ["5 Ablation Studies"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 8, "page_start": 8, "page_end": 8, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=8", "section": "5.2 Effect of Model Size", "subsection": null, "heading_path": ["5.2 Effect of Model Size"]} -->
...
|                                       | Tasks MNLI-m QNLI MRPC SST-2 SQuAD (Acc) (Acc) (Acc) (Acc) (F1)   |
|---------------------------------------|-------------------------------------------------------------------|
...
<!-- section_metadata: {"section": "5.1 Effect of Pre-training Tasks", "subsection": null, "heading_path": ["5.1 Effect of Pre-training Tasks"]} -->
...
<!-- section_metadata: {"section": "5.2 Effect of Model Size", "subsection": null, "heading_path": ["5.2 Effect of Model Size"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 9, "page_start": 9, "page_end": 9, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=9", "section": "6 Conclusion", "subsection": null, "heading_path": ["6 Conclusion"]} -->

## 5.3 Feature-based Approach with BERT
<!-- section_metadata: {"section": "5.3 Feature-based Approach with BERT", "subsection": null, "heading_path": ["5.3 Feature-based Approach with BERT"]} -->
...
|                                | Hyperparams Dev Set Accuracy        | Hyperparams Dev Set Accuracy   | Hyperparams Dev Set Accuracy   | Hyperparams Dev Set Accuracy   |
|--------------------------------|-------------------------------------|--------------------------------|--------------------------------|--------------------------------|
...
## 6 Conclusion
<!-- section_metadata: {"section": "6 Conclusion", "subsection": null, "heading_path": ["6 Conclusion"]} -->

Recent empirical improvements due to transfer learning with language models have demonstrated that rich, unsupervised pre-training is an integral part of many language understanding systems. In particular, these results enable even low-resource tasks to benefit from deep unidirectional architectures. Our major contribution is further generalizing these findings to deep bidirectional architectures, allowing the same pre-trained model to successfully tackle a broad set of NLP tasks.

---

<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 10, "page_start": 10, "page_end": 10, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=10", "section": "References", "subsection": null, "heading_path": ["References"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 11, "page_start": 11, "page_end": 11, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=11", "section": "References", "subsection": null, "heading_path": ["References"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 12, "page_start": 12, "page_end": 12, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=12", "section": "A.1 Illustration of the Pre-training Tasks", "subsection": null, "heading_path": ["A.1 Illustration of the Pre-training Tasks"]} -->
...
<!-- section_metadata: {"section": "Appendix for \"BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding\"", "subsection": null, "heading_path": ["Appendix for \"BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding\""]} -->
...
<!-- section_metadata: {"section": "A Additional Details for BERT", "subsection": null, "heading_path": ["A Additional Details for BERT"]} -->

## A.1 Illustration of the Pre-training Tasks
<!-- section_metadata: {"section": "A.1 Illustration of the Pre-training Tasks", "subsection": null, "heading_path": ["A.1 Illustration of the Pre-training Tasks"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 13, "page_start": 13, "page_end": 13, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=13", "section": "A.3 Fine-tuning Procedure", "subsection": null, "heading_path": ["A.3 Fine-tuning Procedure"]} -->
...
<!-- image_metadata: {"image_id": "bert_pretraining_page013_image001", "document_name": "bert_pretraining.pdf", "page": 13, "section": "A.3 Fine-tuning Procedure", "subsection": null, "heading_path": ["A.3 Fine-tuning Procedure"], "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=13", "bbox": {"l": 78.33881219029426, "t": 779.1893169225837, "r": 525.0701710864901, "b": 677.8291113027715}, "image_description": "A figura ilustra e compara modelos de linguagens pré-treinados (LLMs), como o BRT, OpenAI GPT e ELMo, mostrando suas arquiteturas internas. Cada modelo é representado com a estrutura de camadas de transformadores (denominados \"T\"), subcamadas pontoconnexões e tokens de entrada/saída. A comparação parece visar destacar diferenças arquitetônicas, como conectividade entre blocos ou variabilidade nas configurações subcamadas, com pontos-chave destacados em laranja.\n", "image_description_model": "nvidia/nemotron-nano-12b-v2-vl:free", "image_description_skipped": false, "image_description_primary_model": "nvidia/nemotron-nano-12b-v2-vl:free"} -->
...
<!-- section_metadata: {"section": "A.2 Pre-training Procedure", "subsection": null, "heading_path": ["A.2 Pre-training Procedure"]} -->
...
<!-- section_metadata: {"section": "A.3 Fine-tuning Procedure", "subsection": null, "heading_path": ["A.3 Fine-tuning Procedure"]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 14, "page_start": 14, "page_end": 14, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=14", "section": "B.1 Detailed Descriptions for the GLUE Benchmark Experiments.", "subsection": null, "heading_path": ["B.1 Detailed Descriptions for the GLUE Benchmark Experiments."]} -->
...
<!-- section_metadata: {"section": "A.4 Comparison of BERT, ELMo ,and OpenAI GPT", "subsection": null, "heading_path": ["A.4 Comparison of BERT, ELMo ,and OpenAI GPT"]} -->
...
<!-- section_metadata: {"section": "A.5 Illustrations of Fine-tuning on Different Tasks", "subsection": null, "heading_path": ["A.5 Illustrations of Fine-tuning on Different Tasks"]} -->
...
<!-- section_metadata: {"section": "B Detailed Experimental Setup", "subsection": null, "heading_path": ["B Detailed Experimental Setup"]} -->

## B.1 Detailed Descriptions for the GLUE Benchmark Experiments.
<!-- section_metadata: {"section": "B.1 Detailed Descriptions for the GLUE Benchmark Experiments.", "subsection": null, "heading_path": ["B.1 Detailed Descriptions for the GLUE Benchmark Experiments."]} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 15, "page_start": 15, "page_end": 15, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=15", "section": "B.1 Detailed Descriptions for the GLUE Benchmark Experiments.", "subsection": null, "heading_path": ["B.1 Detailed Descriptions for the GLUE Benchmark Experiments."]} -->

Figure 4: Illustrations of Fine-tuning BERT on Different Tasks.

<!-- image_metadata: {"image_id": "bert_pretraining_page015_image002", "document_name": "bert_pretraining.pdf", "page": 15, "section": "B.1 Detailed Descriptions for the GLUE Benchmark Experiments.", "subsection": null, "heading_path": ["B.1 Detailed Descriptions for the GLUE Benchmark Experiments."], "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=15", "bbox": {"l": 112.49959414638577, "t": 776.7595539354263, "r": 483.70055662766094, "b": 409.22629290743515}, "image_description": "Esta figura, extraída de um artigo acadêmico, ilustra a aplicação do modelo BERT em quatro tarefas distintas de processamento de linguagem natural. As sub-figuras (a) a (d) demonstram a estrutura de entrada e saída para classificação de pares de frases, classificação de frases únicas, resposta a perguntas e rotulação de sequências, correspondendo a tasks como MNLI, SST-2, SQuAD e CoNLL-2003. O texto visível abaixo de cada diagrama lista os nomes das tasks e conjuntos de dados específicos utilizados em cada cenário.", "image_description_model": "nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free", "image_description_skipped": false, "image_description_primary_model": "nvidia/nemotron-nano-12b-v2-vl:free"} -->
...
<!-- page_metadata: {"document_name": "bert_pretraining.pdf", "page": 16, "page_start": 16, "page_end": 16, "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=16", "section": "C.2 Ablation for Different Masking Procedures", "subsection": null, "heading_path": ["C.2 Ablation for Different Masking Procedures"]} -->

## C Additional Ablation Studies
<!-- section_metadata: {"section": "C Additional Ablation Studies", "subsection": null, "heading_path": ["C Additional Ablation Studies"]} -->

## C.1 Effect of Number of Training Steps
<!-- section_metadata: {"section": "C.1 Effect of Number of Training Steps", "subsection": null, "heading_path": ["C.1 Effect of Number of Training Steps"]} -->
...
<!-- section_metadata: {"section": "C.2 Ablation for Different Masking Procedures", "subsection": null, "heading_path": ["C.2 Ablation for Different Masking Procedures"]} -->
...
<!-- image_metadata: {"image_id": "bert_pretraining_page016_image001", "document_name": "bert_pretraining.pdf", "page": 16, "section": "C.2 Ablation for Different Masking Procedures", "subsection": null, "heading_path": ["C.2 Ablation for Different Masking Procedures"], "pdf_link": "corpus/raw/aula04/bert_pretraining.pdf#page=16", "bbox": {"l": 74.1228834670037, "t": 270.9188305264662, "r": 271.1105642676353, "b": 140.00832050143265}, "image_description": "O gráfico apresenta um aumento na MMLI Dev Acuracy de ambos os modelos BERTBASE, com o modelo de Masquerade LM alcançando uma precisão maior de aproximadamente 83,5% contra 82,5% do modelo Left-to-Right.\n\nEste comportamento reflete um resultado comum em transformadores de linguagem natural, onde o contexto bilateral proporciona maior capturar padrões sequenciais.\n\nO experimento provavelmente avalia a efetividade de pré-treinamento em diferentes configurações de modelos BERTBASE para tarefas de inferência, comum em estudos sobre processamento de linguagem natural.\n", "image_description_model": "nvidia/nemotron-nano-12b-v2-vl:free", "image_description_skipped": false, "image_description_primary_model": "nvidia/nemotron-nano-12b-v2-vl:free"} -->
...
| Masking Rates Dev Set Results   | Masking Rates Dev Set Results     | Masking Rates Dev Set Results   |
|---------------------------------|-----------------------------------|---------------------------------|
